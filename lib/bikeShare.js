...
(function() {
  var async, config, db, feeds, getCities, getCity, host, mongo, open, port, prepareResources, remapData, remapErrors, remapLatLong, remapProperty, run, saveAllStations, server, translateData, update, updateData, updateFeeds, updateStations, utils, _ref;
