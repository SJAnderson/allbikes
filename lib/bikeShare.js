...
(function() {
  var async, config, db, feeds, filterCity, getCities, getCity, host, listenToStations, mongo, open, port, prepareResources, remapData, remapErrors, remapLatLong, remapProperty, run, saveAllStations, server, translateData, update, updateData, updateFeeds, updateStations, utils, _ref,
  ...
  module.exports = {
    ...
    closestStations: function(req, res) {
      var cities, city, err, feed, lat, loc, long, stations, _ref1, _ref2;
